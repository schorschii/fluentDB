				...
				<td colspan='999'>
					<div class='spread'>
						...
						<div class='controls'>
							...
							<button onclick='confirmRemoveObjects(getSelectedCheckBoxValues("object_id[]"), event)' <?php if(!$permissionDelete) echo 'disabled'; ?>><img src='img/delete.dyn.svg'>&nbsp;<?php echo LANG('delete'); ?></button>
						</div>
					</div>
				</td>
			</tr>
